...
export class GameSound {
	...
	constructor() {
		...
		this.homeTheme = new Audio("/Tetris/assets/sound/tetris theme.mp3")

		this.crashMusic = new Audio("/Tetris/assets/sound/ding.mp3")
		this.crashMusic.volume = 0.2

		this.collectPointMusic = new Audio("/Tetris/assets/sound/collect-points.mp3")
		this.collectPointMusic.volume = 0.2

		this.gameOverMusic = new Audio("/Tetris/assets/sound/game-over.mp3")
		this.gameOverMusic.volume = 0.2
		this.levelCompletedMusic = new Audio("/Tetris/assets/sound/levelUp.mp3")
